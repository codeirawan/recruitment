    ...
    <div class="kt-portlet__body kt-portlet__body--fit">
        <div class="kt-grid kt-grid--desktop-xl kt-grid--ver-desktop-xl  kt-wizard-v1" id="kt_wizard_v1" data-ktwizard-state="step-first">
                ...
                <div class="kt-wizard-v1__nav">
                    ...
                    <div class="kt-wizard-v1__nav-details">
                        <div class="kt-wizard-v1__nav-item-wrapper" data-ktwizard-type="step-info" data-ktwizard-state="current">
                            <div class="kt-wizard-v1__nav-item-title">{{ __('Describe your duties and responsibilities in your last position') }}</div>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                <form class="kt-form" id="kt_form_1" action="{{ route('recruitment.register.step-11.validate', $id) }}" method="POST">
                    @csrf
                        ...
                        <div class="kt-form__section kt-form__section--first">
                            <div class="row justify-content-center">
                                <div class="form-group col-lg-8">
                                    <textarea id="uraian_tugas" name="uraian_tugas" rows="3" class="form-control @error('uraian_tugas') is-invalid @enderror">{{ old('uraian_tugas', $data['uraian_tugas']) }}</textarea>
