...
@section('title')
    {{ __('Payment Method') }} | {{ config('app.name') }}
@endsection
...
<div class="kt-portlet">
    <div class="kt-portlet__body">
        <div class="kt-portlet__content">
            ...
            @if (Laratrust::can('create-payment-method'))
                <a href="{{ route('master.payment-method.create') }}" class="btn btn-primary mb-4">
                    <i class="fa fa-plus"></i> {{ __('New Payment Method') }}
                </a>
            @endif
...
@section('script')
    @include('layouts.inc.modal.delete', ['object' => 'payment method'])
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.payment-method.data') }}',
