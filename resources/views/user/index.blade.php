    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            columns: [
                ...
                { title: "{{ __('Role') }}", data: 'role', name: 'role', defaultContent: '-', class: 'text-center', searchable: false },
                { title: "{{ __('Active') }}", data: 'active', name: 'active', defaultContent: '-', class: 'text-center', searchable: false },
