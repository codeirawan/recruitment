...
class UserController extends Controller
{
    ...
    {
        if (!Laratrust::isAbleTo('create-user')) return abort(404);
    ...
    {
        if (!Laratrust::isAbleTo('update-user')) return abort(404);
    ...
    {
        if (!Laratrust::isAbleTo('delete-user')) return abort(404);
