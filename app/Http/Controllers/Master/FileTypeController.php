...
class FileTypeController extends Controller
{
    ...
    {
        if (!Laratrust::can('view-file-type')) return abort(404);
    ...
    public function data()
    {
        ...
        return DataTables::of($fileTypes)
            ->addColumn('action', function($fileType) {
                ...
                return (Laratrust::can('update-file-type') ? $edit : '') . (Laratrust::can('delete-file-type') ? $delete : '');
            })
            ->rawColumns(['action'])
            ->make(true);
    }
    ...
    {
        if (!Laratrust::can('create-file-type')) return abort(404);
    ...
    {
        if (!Laratrust::can('update-file-type')) return abort(404);
    ...
    {
        if (!Laratrust::can('delete-file-type')) return abort(404);
